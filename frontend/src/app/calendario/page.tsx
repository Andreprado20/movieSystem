  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white p-6 md:p-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        {/* Calendar Section */}
        <div className="bg-gray-800/50 rounded-lg p-6 flex-1">
          ...
          <div className="grid grid-cols-7 gap-1">
            ...
            {calendarDays.map((day, index) => (
              <div
                key={index}
                className={`aspect-square border border-gray-700 p-2 ${day?.day ? "bg-gray-800/30" : "bg-transparent"}`}
              >
                {day?.day && (
        ...
        <div className="w-full lg:w-96 space-y-8">
          {/* Upcoming Events */}
          <div>
            <h2 className="text-2xl font-bold mb-4">Proximos Eventos</h2>
            <div className="space-y-4">
              {upcomingEvents.map((event) => (
                <div key={event.id} className="bg-gray-800/50 rounded-lg overflow-hidden">
                  <div className="p-4">
                    <div className="flex gap-4">
                      <div className="relative w-16 h-16 bg-gray-700 rounded-md overflow-hidden">
                        <Image
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-300">Organizado por {event.organizer}</span>
                      </div>
