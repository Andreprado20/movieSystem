...
import { Home, MessageCircle, Calendar, BarChart2, Plus, Menu } from "lucide-react"
  ...
  return (
    <div className="flex flex-1 h-full">
      ...
      <Button
        variant="ghost"
        size="icon"
        className="md:hidden absolute top-4 left-4 z-10 text-white"
      ...
      <div
        ...
        } md:translate-x-0 fixed md:relative z-20 w-60 md:min-w-60 md:max-w-60 h-full border-r border-gray-800 bg-gray-900 transition-transform duration-300 ease-in-out`}
      >
      ...
      {/* Overlay for mobile */}
      {mobileSidebarOpen && (
        <div className="fixed inset-0 bg-black/50 z-10 md:hidden" onClick={() => setMobileSidebarOpen(false)}></div>
      )}
          ...
          <div className="h-full overflow-y-auto p-4 md:p-6 w-full">
            ...
            <section className="mb-10">
              ...
              <Tabs defaultValue="recentes" className="w-full">
                <TabsList className="mb-4 overflow-x-auto flex md:inline-flex whitespace-nowrap">
